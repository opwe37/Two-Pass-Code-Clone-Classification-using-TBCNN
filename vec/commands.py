...
import sys
import pickle
import vec.ast2vec.train as ast2vec
from vec.node_map import NODE_LIST

LOG_FILE = 'vec/vectorizer.log'

def main():
    """Execute the preprocessor commandline interface."""

    if not os.path.isdir('vec/logs/'):
        os.makedirs('vec/logs/', 0o755)
