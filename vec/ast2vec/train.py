...
from vec.ast2vec import network
from vec.ast2vec import sampling
from vec.node_map import NODE_MAP

from vec.ast2vec.parameters import NUM_FEATURES, LEARN_RATE, BATCH_SIZE, EPOCHS, CHECKPOINT_EVERY
...
def learn_vectors(samples, logdir, outfile, num_feats=NUM_FEATURES, epochs=EPOCHS):
    ...
    with tf.name_scope('saver'):
        ...
        embedding.metadata_path = os.path.join('vec', 'metadata.tsv')
...
def main():
    ...
    learn_vectors(samples, sys.argv[2], sys.argv[3])
